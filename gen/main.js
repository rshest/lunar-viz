...
var _silverio$lunar_viz$Utils$parabolaPt = F2(
	function (_p0, x) {
		var _p1 = _p0;
		return (((_p1._0 * x) * x) + (_p1._1 * x)) + _p1._2;
	});
var _silverio$lunar_viz$Utils$parabolaFrom3pt = F3(
...
var _silverio$lunar_viz$Utils$lerp = F3(
	function (a, b, t) {
		var tc = A3(_elm_lang$core$Basics$clamp, 0, 1, t);
		return (a * (1 - tc)) + (b * tc);
	});
var _silverio$lunar_viz$Utils$frac = function (x) {
	return x - _elm_lang$core$Basics$toFloat(
		_elm_lang$core$Basics$floor(x));
};
var _silverio$lunar_viz$Utils$epsilon = 1.0e-4;
var _silverio$lunar_viz$Utils$isClose = F2(
	function (a, b) {
		return _elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$abs(a - b),
			_silverio$lunar_viz$Utils$epsilon) < 0;
	});

var _silverio$lunar_viz$Constants$dumpHeight = 40;
var _silverio$lunar_viz$Constants$dumpAnimSpeed = 0.5;
var _silverio$lunar_viz$Constants$loadAnimSpeed = 1;
var _silverio$lunar_viz$Constants$moveAnimSpeed = 10;
var _silverio$lunar_viz$Constants$tickTime = 2.0e-2;
var _silverio$lunar_viz$Constants$futureStepOpacity = 0.2;
var _silverio$lunar_viz$Constants$pathGranularity = 64;
var _silverio$lunar_viz$Constants$restSpareOffs = {ctor: '_Tuple2', _0: 32, _1: 12};
var _silverio$lunar_viz$Constants$tankOffs = {ctor: '_Tuple2', _0: -14, _1: 23};
var _silverio$lunar_viz$Constants$wheelPhase = {ctor: '_Tuple2', _0: 1.5, _1: 0.1};
var _silverio$lunar_viz$Constants$wheelOffsR = {ctor: '_Tuple2', _0: 12, _1: -5};
var _silverio$lunar_viz$Constants$wheelOffsL = {ctor: '_Tuple2', _0: -14, _1: -7};
var _silverio$lunar_viz$Constants$shakeSpeed = 250;
var _silverio$lunar_viz$Constants$wheelRotSpeed = -120;
var _silverio$lunar_viz$Constants$wheelSize = 17;
var _silverio$lunar_viz$Constants$roverExt = {ctor: '_Tuple3', _0: 66, _1: 52, _2: 20};
var _silverio$lunar_viz$Constants$barrelExt = {ctor: '_Tuple3', _0: 20, _1: 29, _2: 9};
var _silverio$lunar_viz$Constants$pathRad = 136;
var _silverio$lunar_viz$Constants$moonRad = 150;
var _silverio$lunar_viz$Constants$moonExt = {ctor: '_Tuple2', _0: 400, _1: 400};
var _silverio$lunar_viz$Constants$fuelConsumption = 5;

var _silverio$lunar_viz$Model$totalFuel = function (actions) {
	totalFuel:
	while (true) {
		var _p0 = actions;
		if (_p0.ctor === '::') {
			if (_p0._0.ctor === 'Move') {
				return (_elm_lang$core$Basics$abs(_p0._0._0) * _silverio$lunar_viz$Constants$fuelConsumption) + _silverio$lunar_viz$Model$totalFuel(_p0._1);
			} else {
				var _v1 = _p0._1;
				actions = _v1;
				continue totalFuel;
...
var _silverio$lunar_viz$Model$dump = function (rover) {
	return (_elm_lang$core$Native_Utils.cmp(rover.spare, 0) > -1) ? _elm_lang$core$Maybe$Just(
		_elm_lang$core$Native_Utils.update(
			rover,
			{
				spare: -1,
				barrels: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: rover.pos, _1: rover.spare},
					_1: rover.barrels
				}
			})) : _elm_lang$core$Maybe$Nothing;
};
var _silverio$lunar_viz$Model$pick = F2(
	function (n, rover) {
		return (A2(_silverio$lunar_viz$Utils$isClose, 0, rover.pos) && (_elm_lang$core$Native_Utils.cmp(rover.spare, 0) < 0)) ? _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				rover,
				{spare: n})) : _elm_lang$core$Maybe$Nothing;
	});
var _silverio$lunar_viz$Model$fill = F2(
	function (n, rover) {
		return ((_elm_lang$core$Native_Utils.cmp(n, rover.spare) < 1) && (_elm_lang$core$Native_Utils.cmp(n + rover.fuel, 1) < 1)) ? _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				rover,
				{spare: rover.spare - n, fuel: rover.fuel + n})) : _elm_lang$core$Maybe$Nothing;
	});
var _silverio$lunar_viz$Model$move = F2(
	function (n, rover) {
		var fuel = rover.fuel - (_elm_lang$core$Basics$abs(n) * _silverio$lunar_viz$Constants$fuelConsumption);
		var pos = rover.pos + n;
		return (_elm_lang$core$Native_Utils.cmp(fuel, 0) > -1) ? _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.update(
				rover,
				{
					pos: pos,
					fuel: A2(_elm_lang$core$Basics$max, fuel, 0),
					dir: (_elm_lang$core$Native_Utils.cmp(n, 0) < 0) ? -1 : 1
				})) : _elm_lang$core$Maybe$Nothing;
	});
var _silverio$lunar_viz$Model$takeFuelAt = F3(
	function (pos, fuel, barrels) {
		var _p1 = barrels;
		if ((_p1.ctor === '::') && (_p1._0.ctor === '_Tuple2')) {
			...
			var _p2 = _p1._0._1;
			return (A2(
				_silverio$lunar_viz$Utils$isClose,
				_silverio$lunar_viz$Utils$frac(pos),
				_silverio$lunar_viz$Utils$frac(_p3)) && (_elm_lang$core$Native_Utils.cmp(_p2, fuel) > -1)) ? _elm_lang$core$Maybe$Just(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p3, _1: _p2 - fuel},
					_1: _p4
				}) : A2(
				...
				function (b) {
					return _elm_lang$core$Maybe$Just(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p3, _1: _p2},
							_1: b
						});
				},
				A3(_silverio$lunar_viz$Model$takeFuelAt, pos, fuel, _p4));
		} else {
			return A2(_silverio$lunar_viz$Utils$isClose, pos, 0) ? _elm_lang$core$Maybe$Just(barrels) : _elm_lang$core$Maybe$Nothing;
		}
	});
var _silverio$lunar_viz$Model$load = F2(
	function (n, rover) {
		return (_elm_lang$core$Native_Utils.cmp(rover.fuel + n, 1) < 1) ? A2(
			_elm_lang$core$Maybe$andThen,
			function (b) {
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_Utils.update(
			...
			A3(_silverio$lunar_viz$Model$takeFuelAt, rover.pos, n, rover.barrels)) : _elm_lang$core$Maybe$Nothing;
	});
var _silverio$lunar_viz$Model$init = {
	pos: 0,
	dir: 1,
	fuel: 0,
	spare: -1,
...
var _silverio$lunar_viz$Model$Rover = F5(
	function (a, b, c, d, e) {
		return {pos: a, dir: b, fuel: c, spare: d, barrels: e};
	});
var _silverio$lunar_viz$Model$Stock = function (a) {
	return {ctor: 'Stock', _0: a};
};
var _silverio$lunar_viz$Model$Dump = {ctor: 'Dump'};
var _silverio$lunar_viz$Model$Pick = function (a) {
	return {ctor: 'Pick', _0: a};
};
var _silverio$lunar_viz$Model$Fill = function (a) {
	return {ctor: 'Fill', _0: a};
};
var _silverio$lunar_viz$Model$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _silverio$lunar_viz$Model$evalAction = F2(
	function (action, rover) {
		return A2(
			_elm_lang$core$Maybe$andThen,
			function (r) {
				var _p5 = action;
				switch (_p5.ctor) {
					case 'Move':
						return A2(_silverio$lunar_viz$Model$move, _p5._0, r);
					case 'Load':
						return A2(_silverio$lunar_viz$Model$load, _p5._0, r);
					case 'Fill':
						return A2(_silverio$lunar_viz$Model$fill, _p5._0, r);
					case 'Pick':
						return A2(_silverio$lunar_viz$Model$pick, _p5._0, r);
					case 'Stock':
						return A2(
							_silverio$lunar_viz$Model$evalAction,
							_silverio$lunar_viz$Model$Load(1 - r.fuel),
							A2(
								_silverio$lunar_viz$Model$evalAction,
								_silverio$lunar_viz$Model$Pick(_p5._0),
								rover));
					default:
						return _silverio$lunar_viz$Model$dump(r);
				}
			},
			rover);
	});
var _silverio$lunar_viz$Model$evalActions = F2(
	function (rover, actions) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (a, r) {
					return A2(_silverio$lunar_viz$Model$evalAction, a, r);
				}),
			rover,
			actions);
	});
var _silverio$lunar_viz$Model$Move = function (a) {
	return {ctor: 'Move', _0: a};
};
var _silverio$lunar_viz$Model$planRoute = {
	ctor: '::',
	_0: _silverio$lunar_viz$Model$Stock(1),
	_1: {
		ctor: '::',
		_0: _silverio$lunar_viz$Model$Move(0.1),
		_1: {
			ctor: '::',
			_0: _silverio$lunar_viz$Model$Dump,
			_1: {
				ctor: '::',
				_0: _silverio$lunar_viz$Model$Move(-0.1),
				_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _silverio$lunar_viz$Model$Load(0.5),
											_1: {
												ctor: '::',
												_0: _silverio$lunar_viz$Model$Move(0.1),
												_1: {
																																																					...
																																																					_1: {
																																																						...
																																																						_1: {
																																																							...
																																																							_1: {
																																																								...
																																																								_1: {
																																																									ctor: '::',
																																																									_0: _silverio$lunar_viz$Model$Stock(0.5),
																																																									_1: {
																																																										ctor: '::',
																																																										_0: _silverio$lunar_viz$Model$Move(0.1),
																																																										_1: {
																																																																...
																																																																_1: {
																																																																	...
																																																																	_1: {
																																																																		...
																																																																		_1: {
																																																																			...
																																																																			_1: {
																																																																				ctor: '::',
																																																																				_0: _silverio$lunar_viz$Model$Move(0.2),
																																																																				_1: {
																																																																					ctor: '::',
																																																																					_0: _silverio$lunar_viz$Model$Load(1),
																																																																					_1: {
																																																																						ctor: '::',
																																																																						_0: _silverio$lunar_viz$Model$Move(0.2),
																																																																						_1: {
																																																																							ctor: '::',
																																																																							_0: _silverio$lunar_viz$Model$Fill(1),
																																																																							_1: {
																																																																								ctor: '::',
																																																																								_0: _silverio$lunar_viz$Model$Move(0.2),
																																																																								_1: {
...
var _silverio$lunar_viz$Msg$JumpToStep = function (a) {
	return {ctor: 'JumpToStep', _0: a};
};
var _silverio$lunar_viz$Msg$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};

var _silverio$lunar_viz$Anim$jumpToStep = F2(
	function (anim, n) {
		var route = A2(_elm_lang$core$List$take, n, anim.route);
		var rover = function () {
			var _p0 = A2(
				_silverio$lunar_viz$Model$evalActions,
				_elm_lang$core$Maybe$Just(_silverio$lunar_viz$Model$init),
				route);
			if (_p0.ctor === 'Just') {
				return _p0._0;
			} else {
		...
		return _elm_lang$core$Native_Utils.update(
			anim,
			{step: n, t: 0, rover: rover});
	});
var _silverio$lunar_viz$Anim$duration = function (action) {
	var _p1 = action;
	switch (_p1.ctor) {
		case 'Move':
			return _elm_lang$core$Basics$abs(_p1._0) * _silverio$lunar_viz$Constants$moveAnimSpeed;
		case 'Load':
			return _p1._0 * _silverio$lunar_viz$Constants$loadAnimSpeed;
		case 'Fill':
			return _p1._0 * _silverio$lunar_viz$Constants$loadAnimSpeed;
		case 'Pick':
			return _silverio$lunar_viz$Constants$dumpAnimSpeed;
		case 'Stock':
			return _silverio$lunar_viz$Constants$dumpAnimSpeed;
		default:
			return _silverio$lunar_viz$Constants$dumpAnimSpeed;
...
var _silverio$lunar_viz$Anim$dumpParabola = A3(
	_silverio$lunar_viz$Utils$parabolaFrom3pt,
	{ctor: '_Tuple2', _0: 0, _1: 0},
	{
		ctor: '_Tuple2',
		_0: _elm_lang$core$Tuple$first(_silverio$lunar_viz$Constants$restSpareOffs) / 2,
		_1: _silverio$lunar_viz$Constants$dumpHeight
	},
	_silverio$lunar_viz$Constants$restSpareOffs);
var _silverio$lunar_viz$Anim$dumpInterp = F3(
	function (anim, n, t) {
		var rover = anim.rover;
		var x = _elm_lang$core$Tuple$first(_silverio$lunar_viz$Constants$restSpareOffs) * (1 - t);
		var y = A2(_silverio$lunar_viz$Utils$parabolaPt, _silverio$lunar_viz$Anim$dumpParabola, x);
		return _elm_lang$core$Native_Utils.update(
			anim,
			{
				spareOffs: {ctor: '_Tuple2', _0: x, _1: y},
				rover: _elm_lang$core$Native_Utils.update(
					rover,
					{spare: n})
			});
	});
var _silverio$lunar_viz$Anim$curAction = function (anim) {
	return _elm_lang$core$List$head(
		A2(_elm_lang$core$List$drop, anim.step, anim.route));
};
var _silverio$lunar_viz$Anim$interp = function (anim) {
	var interpEval = function (a) {
		var _p2 = A2(
			_silverio$lunar_viz$Model$evalAction,
			a,
			_elm_lang$core$Maybe$Just(anim.rover));
		if (_p2.ctor === 'Nothing') {
			return anim;
		} else {
			return _elm_lang$core$Native_Utils.update(
	...
	var _p3 = _silverio$lunar_viz$Anim$curAction(anim);
	if (_p3.ctor === 'Just') {
		switch (_p3._0.ctor) {
			case 'Move':
				return interpEval(
					_silverio$lunar_viz$Model$Move(anim.t * _p3._0._0));
			case 'Load':
				return interpEval(
					_silverio$lunar_viz$Model$Load(anim.t * _p3._0._0));
			case 'Fill':
				return interpEval(
					_silverio$lunar_viz$Model$Fill(anim.t * _p3._0._0));
			case 'Pick':
				return A3(_silverio$lunar_viz$Anim$dumpInterp, anim, _p3._0._0, 1 - anim.t);
			case 'Dump':
				return A3(_silverio$lunar_viz$Anim$dumpInterp, anim, anim.rover.spare, anim.t);
			default:
				var anim1 = interpEval(
					_silverio$lunar_viz$Model$Load(anim.t * (1 - anim.rover.fuel)));
				return A3(_silverio$lunar_viz$Anim$dumpInterp, anim1, _p3._0._0, 1 - anim.t);
		}
	} else {
		return anim;
	}
};
var _silverio$lunar_viz$Anim$RoverAnim = F6(
	function (a, b, c, d, e, f) {
		return {rover: a, spareOffs: b, step: c, t: d, status: e, route: f};
	});
var _silverio$lunar_viz$Anim$Done = {ctor: 'Done'};
var _silverio$lunar_viz$Anim$Stuck = {ctor: 'Stuck'};
var _silverio$lunar_viz$Anim$advance = F2(
	function (anim, dt) {
		advance:
		while (true) {
			var _p4 = _silverio$lunar_viz$Anim$curAction(anim);
			if (_p4.ctor === 'Nothing') {
				return _elm_lang$core$Native_Utils.update(
					anim,
					{status: _silverio$lunar_viz$Anim$Done});
			} else {
				var _p6 = _p4._0;
				var t = anim.t + (dt / _silverio$lunar_viz$Anim$duration(_p6));
				if (_elm_lang$core$Native_Utils.cmp(t, 1) < 0) {
					return _elm_lang$core$Native_Utils.update(
						anim,
						{t: t});
				} else {
					...
					if (_p5.ctor === 'Nothing') {
						return _elm_lang$core$Native_Utils.update(
							anim,
							{status: _silverio$lunar_viz$Anim$Stuck});
					} else {
						var _v6 = _elm_lang$core$Native_Utils.update(
							anim,
...
var _silverio$lunar_viz$Anim$InProgress = {ctor: 'InProgress'};
var _silverio$lunar_viz$Anim$init = {
	ctor: '_Tuple2',
	_0: {rover: _silverio$lunar_viz$Model$init, spareOffs: _silverio$lunar_viz$Constants$restSpareOffs, step: 0, t: 0, status: _silverio$lunar_viz$Anim$InProgress, route: _silverio$lunar_viz$Model$planRoute},
	_1: _elm_lang$core$Platform_Cmd$none
};

var _silverio$lunar_viz$View$actionElem = F3(
	function (index, opacity, action) {
			...
			switch (_p1.ctor) {
				case 'Move':
					...
					return {
						...
						_1: A2(
							textNum,
							(_elm_lang$core$Native_Utils.cmp(_p2, 0) < 0) ? 'cw ' : 'ccw ',
							_elm_lang$core$Basics$abs(_p2))
					};
				case 'Load':
					return {
						ctor: '_Tuple2',
				...
				case 'Stock':
					...
					return {
						ctor: '_Tuple2',
						_0: 'act_stock',
						_1: A2(_silverio$lunar_viz$Utils$isClose, _p3, 1) ? 'stock' : A2(textNum, 'stock ', _p3)
					};
				default:
					return {ctor: '_Tuple2', _0: 'act_dump', _1: 'dump'};
			}
		}();
		var cl = _p0._0;
		var txt = _p0._1;
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_silverio$lunar_viz$Msg$JumpToStep(index)),
						_1: {ctor: '[]'}
					}
				}
			},
		...
		return _elm_lang$core$Native_Utils.eq(cl, 'act_stock') ? {
			ctor: '::',
			_0: A2(
...
var _silverio$lunar_viz$View$roverPath = function (pos) {
	var dottedLine = _evancz$elm_graphics$Collage$dashed(_elm_lang$core$Color$blue);
	var n = pos * _silverio$lunar_viz$Constants$pathGranularity;
	var nn = _elm_lang$core$Basics$round(n);
	var range = (_elm_lang$core$Native_Utils.cmp(pos, 0) > 0) ? _elm_lang$core$List$reverse(
		A2(_elm_lang$core$List$range, 0, nn)) : A2(_elm_lang$core$List$range, nn, 0);
	var i2pt = function (i) {
		var ang = ((((0 - _elm_lang$core$Basics$toFloat(i)) * 2) * _elm_lang$core$Basics$pi) * pos) / n;
		return {
			ctor: '_Tuple2',
			_0: _silverio$lunar_viz$Constants$pathRad * _elm_lang$core$Basics$sin(ang),
			_1: _silverio$lunar_viz$Constants$pathRad * _elm_lang$core$Basics$cos(ang)
		};
	};
	return A2(
		...
		_evancz$elm_graphics$Collage$path(
			A2(_elm_lang$core$List$map, i2pt, range)));
};
var _silverio$lunar_viz$View$moveRot = F3(
	function (offs, rot, f) {
		return A2(
			...
			_evancz$elm_graphics$Collage$group(
				{
					ctor: '::',
					_0: A2(_evancz$elm_graphics$Collage$move, offs, f),
					_1: {ctor: '[]'}
				}));
	});
var _silverio$lunar_viz$View$img = F3(
	function (name, w, h) {
		return A3(
			_evancz$elm_graphics$Element$image,
			w,
...
var _silverio$lunar_viz$View$barrel = F2(
	function (offs, fuel) {
		var _p4 = _silverio$lunar_viz$Constants$barrelExt;
		var w = _p4._0;
		var h = _p4._1;
		var lid = _p4._2;
		var hf = (h - lid) * fuel;
			...
			_evancz$elm_graphics$Collage$group(
				{
					...
					_0: A2(
						...
						A2(
							...
							A2(_evancz$elm_graphics$Collage$rect, w - 4, hf))),
					_1: {
						ctor: '::',
						_0: _evancz$elm_graphics$Collage$toForm(
							A3(_silverio$lunar_viz$View$img, 'barrel', w, h)),
						_1: {ctor: '[]'}
					}
				}));
	});
var _silverio$lunar_viz$View$barrel_ground = function (_p5) {
	var _p6 = _p5;
	return A3(
		_silverio$lunar_viz$View$moveRot,
		{ctor: '_Tuple2', _0: 0, _1: _silverio$lunar_viz$Constants$moonRad},
		(_p6._0 * 2) * _elm_lang$core$Basics$pi,
		A2(
			_silverio$lunar_viz$View$barrel,
			{ctor: '_Tuple2', _0: 0, _1: 0},
			_p6._1));
};
var _silverio$lunar_viz$View$wheel = F2(
	function (offs, rot) {
		return A2(
			_evancz$elm_graphics$Collage$rotate,
			rot * _silverio$lunar_viz$Constants$wheelRotSpeed,
			A2(
				_evancz$elm_graphics$Collage$move,
				offs,
				_evancz$elm_graphics$Collage$toForm(
					A3(_silverio$lunar_viz$View$img, 'wheel', _silverio$lunar_viz$Constants$wheelSize, _silverio$lunar_viz$Constants$wheelSize))));
	});
var _silverio$lunar_viz$View$vehicle = function (anim) {
	var _p7 = anim.rover;
	var pos = _p7.pos;
	var dir = _p7.dir;
	var fuel = _p7.fuel;
	var spare = _p7.spare;
	var wheelm = pos * dir;
	var shake = _elm_lang$core$Basics$sin(pos * _silverio$lunar_viz$Constants$shakeSpeed);
	var soffs = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Tuple$first(anim.spareOffs),
		_1: _elm_lang$core$Tuple$second(anim.spareOffs) - shake
	};
	var _p8 = _silverio$lunar_viz$Constants$roverExt;
	var w = _p8._0;
	var h = _p8._1;
	var hoffs = _p8._2;
	return A3(
		_silverio$lunar_viz$View$moveRot,
		{ctor: '_Tuple2', _0: 0, _1: _silverio$lunar_viz$Constants$moonRad},
		(pos * 2) * _elm_lang$core$Basics$pi,
		A2(
			_evancz$elm_graphics$Collage$groupTransform,
			_evancz$elm_graphics$Transform$scaleX(0 - dir),
			{
				ctor: '::',
				_0: A2(
					_silverio$lunar_viz$View$barrel,
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Tuple$first(_silverio$lunar_viz$Constants$tankOffs),
						_1: _elm_lang$core$Tuple$second(_silverio$lunar_viz$Constants$tankOffs) + shake
					},
					fuel),
				_1: {
					ctor: '::',
					_0: A2(
						...
						hoffs + shake,
						_evancz$elm_graphics$Collage$toForm(
							A3(_silverio$lunar_viz$View$img, 'rover', w, h))),
					_1: {
						ctor: '::',
						_0: A2(
							_silverio$lunar_viz$View$wheel,
							_silverio$lunar_viz$Constants$wheelOffsL,
							wheelm + _elm_lang$core$Tuple$first(_silverio$lunar_viz$Constants$wheelPhase)),
						_1: {
							ctor: '::',
							_0: A2(
								_silverio$lunar_viz$View$wheel,
								_silverio$lunar_viz$Constants$wheelOffsR,
								wheelm + _elm_lang$core$Tuple$second(_silverio$lunar_viz$Constants$wheelPhase)),
							_1: {
								ctor: '::',
								_0: (_elm_lang$core$Native_Utils.cmp(spare, 0) > -1) ? A2(_silverio$lunar_viz$View$barrel, soffs, spare) : _evancz$elm_graphics$Collage$group(
									{ctor: '[]'}),
								_1: {ctor: '[]'}
							}
						}
...
var _silverio$lunar_viz$View$view = function (anim) {
	var indices = A2(
		_elm_lang$core$List$range,
		0,
		_elm_lang$core$List$length(anim.route) - 1);
	var opacities = A2(
		_elm_lang$core$List$map,
		function (i) {
			return (_elm_lang$core$Native_Utils.cmp(i, anim.step) < 0) ? 1 : (_elm_lang$core$Native_Utils.eq(i, anim.step) ? A3(_silverio$lunar_viz$Utils$lerp, _silverio$lunar_viz$Constants$futureStepOpacity, 1, anim.t) : _silverio$lunar_viz$Constants$futureStepOpacity);
		},
		indices);
	var actionElems = _elm_lang$core$List$concat(
		A4(_elm_lang$core$List$map3, _silverio$lunar_viz$View$actionElem, indices, opacities, anim.route));
	var steps = A2(_elm_lang$core$List$take, anim.step, anim.route);
	var animInt = _silverio$lunar_viz$Anim$interp(anim);
	var rover = animInt.rover;
	var _p9 = _silverio$lunar_viz$Constants$moonExt;
	var mw = _p9._0;
	var mh = _p9._1;
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: _evancz$elm_graphics$Element$toHtml(
				A3(
					...
					mh,
					{
						ctor: '::',
						_0: _evancz$elm_graphics$Collage$toForm(
							A3(_silverio$lunar_viz$View$img, 'moon', mw, mh)),
						_1: {
							ctor: '::',
							_0: _silverio$lunar_viz$View$roverPath(rover.pos),
							_1: {
								ctor: '::',
								_0: _silverio$lunar_viz$View$vehicle(animInt),
								_1: {
									ctor: '::',
									_0: _evancz$elm_graphics$Collage$group(
										A2(_elm_lang$core$List$map, _silverio$lunar_viz$View$barrel_ground, rover.barrels)),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fuel_pane'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fuel_caption'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Fuel Used:'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fuel_count'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Basics$round(
												_silverio$lunar_viz$Model$totalFuel(steps)))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('route_pane'),
							_1: {ctor: '[]'}
						},
						actionElems),
					_1: {ctor: '[]'}
...
var _silverio$lunar_viz$Main$update = F2(
	function (msg, anim) {
		var _p0 = msg;
		if (_p0.ctor === 'Tick') {
			return {
				ctor: '_Tuple2',
				_0: A2(_silverio$lunar_viz$Anim$advance, anim, _silverio$lunar_viz$Constants$tickTime),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: A2(_silverio$lunar_viz$Anim$jumpToStep, anim, _p0._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _silverio$lunar_viz$Main$subs = function (anim) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * _silverio$lunar_viz$Constants$tickTime, _silverio$lunar_viz$Msg$Tick);
};
var _silverio$lunar_viz$Main$main = _elm_lang$html$Html$program(
	{init: _silverio$lunar_viz$Anim$init, update: _silverio$lunar_viz$Main$update, view: _silverio$lunar_viz$View$view, subscriptions: _silverio$lunar_viz$Main$subs})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _silverio$lunar_viz$Main$main !== 'undefined') {
    _silverio$lunar_viz$Main$main(Elm['Main'], 'Main', undefined);
}
